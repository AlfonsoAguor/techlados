...
<body onLoad="javascript:ocultar();" id="bodyForm">
    <form name='buscar' method='post' action='buscar2.php' id="formu">
        <table id="tabla">
         <tr>
          ...
          <tr>
              <td>Nombre: </td>
              <td><input type="text" name="nombre" size="20" TabIndex="1" onChange="javascript:comprobar_nom('buscar');" onkeypress="javascript:return acceptLet(event);"> <label id="aNom"> <img src="../img/advertencia.png" height='15' width='15'>oblig</label></td>
          </tr>  
          <tr>
              <td><input type="radio" name="docu" value=0 checked>DNI</td>
              <td rowspan="2"><input type="text" size="10" name="docuNumero" onChange="javascript:comp_dni_nie('buscar');"></td>
          </tr>
          <tr>
